              ...
              <form className="needs-validation" onSubmit={onSubmitHandler}>
                <div className="row g-3">
                  <div className="col-sm-6">
                    ...
                    <input type="text" className="form-control" id="firstName" placeholder="Jhon" required 
                      name='firstName'
                  ...
                  <div className="col-md-3"> 
                    ...
                    <input type="number" className="form-control" id="zip" placeholder="54321" required 
                      name='zip'
                      onChange={onChangeHandler}
                      value={data.zip} /> 
                  </div>
